...
1. we have to decide in which way we can visualise the data
2. Create the data visualization. Use artistic principles including size, color, and shape.
...
Key tasks
 presenting your case study to a friend or family member.
Wrap-up
Thus, the Cyclistic bike-share case study is done covering all the phases like
